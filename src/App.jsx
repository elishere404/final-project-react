    ...
    <div className={`min-h-screen transition-colors duration-300 ${darkMode ? 'bg-gray-900 text-white' : 'bg-white text-gray-900'}`} style={{ fontFamily }}>
      <div className="max-w-3xl mx-auto p-6">
        ...
        <input
          ...
          className={`w-full p-4 rounded-2xl mb-2 ${darkMode ? 'bg-gray-800 border-gray-700' : 'bg-gray-100 border-gray-200'} ${inputError ? 'border-red-500' : ''} focus:outline-none focus:ring-2 focus:ring-purple-500`}
